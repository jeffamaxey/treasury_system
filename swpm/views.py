...
def pricing(request, commit=False):
    ...
    if request.POST['trade_type'] == 'FX Option':
        ...
        if not swap_form.is_valid() or not swap_leg_form_set.is_valid():
            return trade(request,
                         inst='swap',
